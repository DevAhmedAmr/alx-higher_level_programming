...
#define _Py_Dealloc(op) ( \
	_Py_INC_TPFREES(op) _Py_COUNT_ALLOCS_COMMA(*Py_TYPE(op)->tp_dealloc)((PyObject *)(op)))
#endif /* !Py_TRACE_REFS */
...
#define Py_DECREF(op)                                                                 \
	do                                                                                \
	{                                                                                 \
		if (_Py_DEC_REFTOTAL _Py_REF_DEBUG_COMMA--((PyObject *)(op))->ob_refcnt != 0) \
			_Py_CHECK_REFCNT(op) else _Py_Dealloc((PyObject *)(op));                  \
	} while (0)
...
#define Py_TRASHCAN_SAFE_END(op)                               \
	...
	else _PyTrash_deposit_object((PyObject *)op);
